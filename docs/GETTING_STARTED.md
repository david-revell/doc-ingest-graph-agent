...
Create the venv (adjust the path to your preferred location):

```powershell
python -m venv C:\venvs\doc_ingest_graph_agent_venv
```

Activate the venv (PowerShell):

```powershell
C:\venvs\doc_ingest_graph_agent_venv\Scripts\Activate.ps1
```
