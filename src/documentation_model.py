...
class Document:
    ...
    async def generate_document_summaries(self):
        """TODO: generate document/page summaries (stub)."""
        print("TODO: generate_document_summaries is not implemented yet")

    async def detect_best_representation(self):
